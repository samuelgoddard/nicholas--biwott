  ...
  return(
    <div className="w-full relative">
      <div className="absolute top-0 left-0 ml-[-50px] mt-[-5%] md:mt-[-5%] xl:mt-[-5%] 3xl:mt-[-120px] flex flex-wrap overflow-hidden" data-scroll data-scroll-speed={-0.7}>
        <span className="w-full text-gold block text-[22vw] xl:text-[20vw] 3xl:text-[400px] leading-none font-display opacity-10">{backTextFirst ? backTextFirst : 'About'}</span>
        <span className="text-gold block text-[22vw] xl:text-[20vw] 3xl:text-[450px] leading-none font-display opacity-10 ml-auto mr-[-50px]">{backTextSecond ? backTextSecond : 'Nicholas'}</span>
      </div>
